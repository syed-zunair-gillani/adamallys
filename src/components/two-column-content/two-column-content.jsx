...
const TwoColumnContent = (props) => {
  ...
  return (
    <section id={id} className={`bg-white container px-[18px] lg:px-0 mx-auto flex flex-col md:flex-row mb-4 ${zeroGap ? 'gap-4 md:gap-0' : 'gap-4'} ${invert && "md:!flex-row-reverse"}`}>
      <div
