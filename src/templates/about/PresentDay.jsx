...
const PresentDay = ({ data }) => {
  return (
    <div className='flex flex-col sticky top-0 lg:flex-row '>
      ...
      <div
        className="relative flex-1 basis-[50%] relative flex flex-col gap-[16px] justify-center p-[30px] md:p-[60px] lg:p-[110px]"
      >
